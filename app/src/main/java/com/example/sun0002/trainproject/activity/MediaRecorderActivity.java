...
import com.example.sun0002.trainproject.databinding.ActivityMediaRecorderBinding;
...
public class MediaRecorderActivity extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    private ActivityMediaRecorderBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_media_recorder);
        setWindow();
